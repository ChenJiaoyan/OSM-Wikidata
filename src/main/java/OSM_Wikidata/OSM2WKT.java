...
//            wayr.clear();
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String Area = "Australia";
        String rootPath = "F:\\SmallApple\\OSM-Wikidata_data\\Data\\OSM\\";
        String rootPath2 = "F:\\SmallApple\\OSM-Wikidata_data\\other\\" + Area + "\\";
        ...
        */
        ...
        /*
        Relation r = getRelationByID("172053", rootPath2 + "OSMRelation_Australia.txt");
        ...
        */
        //3557599--Q28225180--Devonshire Street Pedestrian Tunnel------[17607173, 4091996974]
        Way w = getWaybyID("3557599", rootPath2 + "OSMWay_Australia.txt");
        System.out.println(way2WKT(w, rootPath2 + "OSMNode_Australia.txt"));
