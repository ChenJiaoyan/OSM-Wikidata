...
public class HandleJSONFiles {
    ...
    public static void tripleExt(String filePath, String encode, String resultPath) throws Exception {
        //setUp();
        ...
        try {
            ...
            while ((stringLine = reader.readLine()) != null) {
                ...
                if(newstr.indexOf("\"id\":\"Q936\"", i) > j) { //如果这个entity有OSM的references
                    ...
                    HandleFiles.WirteFile(resultPath, buf + "\r\n");
                }
            }
            reader.close();
            //System.out.println("all\t" + all + "zh" + zh + "r" + r);
            //HandleFiles.WirteFile("F:/Wikiquantity.txt", country + "\r\n" + all + "\r\n" + zh + "\r\n" + r + "\r\n");
            System.out.println("all\t" + all + "r" + r);
            HandleFiles.WirteFile("F:/Wikiquantity.txt", all + "\r\n" + r + "\r\n");
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            tripleExt(filePath, encode, resultPath);
        } catch (IOException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
